			...
			<div class="span7">
				<div class="control-group">
					<label for="funxvotes_artist_id" class="control-label">
						<?php echo JText::_('Volunteer'); ?>
					</label>
					<div class="controls">
						<?php echo VolunteersHelperSelect::volunteer($this->item->volunteers_volunteer_id); ?>
					</div>
				</div>
				<div class="control-group">
					<label for="funxvotes_artist_id" class="control-label">
				...
				<div class="control-group">
					...
					<div class="controls">
						<?php echo VolunteersHelperSelect::role($this->item->role); ?>
					</div>
				</div>
				<div class="control-group">
