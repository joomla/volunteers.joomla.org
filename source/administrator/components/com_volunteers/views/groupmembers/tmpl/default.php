...
<div class="volunteers">
	<form name="adminForm" id="adminForm" action="index.php" method="post">
		...
		<input type="hidden" name="view" id="view" value="groupmembers" />
		...
		<div id="filter-bar" class="btn-toolbar">
			<div class="btn-groupmember pull-right hidden-phone">
			...
			<div class="btn-groupmember pull-right">
		...
		<table class="adminlist table table-striped">
			<thead>
				<tr>
					...
					<th width="20%">
						<?php echo JHTML::_('grid.sort', 'Volunteer', 'volunteer_firstname', $this->lists->order_Dir, $this->lists->order) ?>
					</th>
					<th width="20%">
						<?php echo JHTML::_('grid.sort', 'Group Title', 'group_title', $this->lists->order_Dir, $this->lists->order) ?>
					</th>
					<th>
						<?php echo JHTML::_('grid.sort', 'Role', 'category', $this->lists->order_Dir, $this->lists->order) ?>
					</th>
				...
				<tr>
					...
					<td></td>
					<td><?php echo VolunteersHelperSelect::volunteer($this->escape($this->getModel()->getState('volunteer_id',''))); ?></td>
					<td><?php echo VolunteersHelperSelect::group($this->escape($this->getModel()->getState('volunteer_id',''))); ?></td>
					<td></td>
					<td></td>
				</tr>
			</thead>
			...
			<?php $i = -1; $m = 1; ?>
				...
				<tr class="<?php echo 'row'.$m; ?>">
					<td>
						<?php echo JHTML::_('grid.id', $i, $item->volunteers_groupmember_id, $checkedOut); ?>
					</td>
					<td class="center">
					...
					<td align="left">
						<a class="btn btn btn-small" href="<?php echo JRoute::_('index.php?option=com_volunteers&view=groupmember&id='.$item->volunteers_groupmember_id) ?>" class="volunteersitem"><span class="icon-edit"></span>Edit</a>
					</td>
					...
					<td align="left">
						<a href="<?php echo JRoute::_('index.php?option=com_volunteers&view=volunteer&id='.$item->volunteers_volunteer_id) ?>" class="volunteersitem">
							<strong><?php echo $this->escape($item->volunteer_firstname) ?> <?php echo $this->escape($item->volunteer_lastname) ?></strong>
						</a>
					</td>

					<td align="left">
						<a href="<?php echo JRoute::_('index.php?option=com_volunteers&view=group&id='.$item->volunteers_group_id) ?>" class="volunteersitem">
							<strong><?php echo $this->escape($item->group_title) ?></strong>
						</a>
					</td>

					<td align="left">
						<?php echo VolunteersHelperFormat::role($item->role); ?>
					</td>
