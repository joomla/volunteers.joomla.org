...
$sortFields = array(
	...
	'group_title'			=> JText::_('COM_VOLUNTEERS_FIELD_NAME'),
...
<div class="volunteers">
	<form name="adminForm" id="adminForm" action="index.php" method="post">
		...
		<input type="hidden" name="view" id="view" value="groups" />
		...
		<table class="adminlist table table-striped">
			<thead>
				<tr>
					...
					<th width="20%">
						<?php echo JHTML::_('grid.sort', 'COM_VOLUNTEERS_FIELD_NAME', 'group_title', $this->lists->order_Dir, $this->lists->order) ?>
					</th>
			...
			<?php $i = -1; $m = 1; ?>
				...
				<tr class="<?php echo 'row'.$m; ?>">
					<td>
						<?php echo JHTML::_('grid.id', $i, $item->volunteers_group_id, $checkedOut); ?>
					</td>
					<td class="center">
