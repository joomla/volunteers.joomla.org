...
class SsoModelCertificate extends FormModel
{
	...
	public function getCertificates()
	{
		...
		return JFolder::files(JPATH_LIBRARIES . '/simplesamlphp/cert');
	}
	...
	{
		// Get the form.
		$form = $this->loadForm($this->context, 'certificate', array('control' => 'jform', 'load_data' => $loadData));
	...
	public function save($data)
	{
		...
		$privateKey     = $folder . '/' . $data['certificate']['privateKey'];
		$certificateKey = $folder . '/' . $data['certificate']['certificateKey'];
