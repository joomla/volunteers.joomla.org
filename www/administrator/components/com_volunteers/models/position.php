 ...
 * Position model.
 */
class VolunteersModelPosition extends JModelAdmin
{
	/**
	 ...
	 */
	public function getTable($type = 'Position', $prefix = 'VolunteersTable', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_volunteers.edit.position.data', array());
