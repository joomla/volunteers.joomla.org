 ...
 */
class VolunteersViewPosition extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		// Set toolbar title
		JToolbarHelper::title($isNew ? JText::_('COM_VOLUNTEERS') . ': ' . JText::_('COM_VOLUNTEERS_TITLE_POSITIONS_NEW') : JText::_('COM_VOLUNTEERS') . ': ' . JText::_('COM_VOLUNTEERS_TITLE_POSITIONS_EDIT'), 'joomla');
		...
		else
		{
			...
			{
				JToolbarHelper::versions('com_volunteers.position', $this->item->id);
			}
