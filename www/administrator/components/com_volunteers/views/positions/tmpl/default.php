...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_volunteers&task=positions.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'itemsList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
?>

<form action="<?php echo JRoute::_('index.php?option=com_volunteers&view=positions'); ?>" method="post" name="adminForm" id="adminForm">
			...
			<?php else : ?>
				<table class="table table-striped" id="itemsList">
					...
					<?php foreach ($this->items as $i => $item) :
						...
						?>
						<tr class="row<?php echo $i % 2; ?>" sortable-position-id="<?php echo $item->id ?>">
							...
							<td class="nowrap has-context">
								...
								<?php endif; ?>
								<?php if ($canEdit) : ?>
									<a href="<?php echo JRoute::_('index.php?option=com_volunteers&task=position.edit&id=' . (int) $item->id); ?>">
