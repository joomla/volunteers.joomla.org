 ...
 */
class VolunteersViewPositions extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		VolunteersHelper::addSubmenu('positions');
	...
	protected function addToolbar()
	{
		...
		// Set toolbar title
		JToolbarHelper::title(JText::_('COM_VOLUNTEERS') . ': ' . JText::_('COM_VOLUNTEERS_TITLE_POSITIONS'), 'joomla');
