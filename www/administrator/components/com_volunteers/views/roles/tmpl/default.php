...
<form action="<?php echo JRoute::_('index.php?option=com_volunteers&view=roles'); ?>" method="post" name="adminForm" id="adminForm">
					...
					<?php foreach ($this->items as $i => $item) :
						...
						<tr class="row<?php echo $i % 2; ?>" sortable-volunteer-id="<?php echo $item->id ?>">
							...
							<td class="nowrap">
								...
								<?php endif; ?>
								<?php if ($canEdit) : ?>
									<a href="<?php echo JRoute::_('index.php?option=com_volunteers&task=role.edit&id=' . (int) $item->id); ?>">
