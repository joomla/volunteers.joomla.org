...
class VolunteersViewTeam extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		// Set toolbar title
		JToolbarHelper::title($isNew ? JText::_('COM_VOLUNTEERS') . ': ' . JText::_('COM_VOLUNTEERS_TITLE_TEAMS_NEW') : JText::_('COM_VOLUNTEERS') . ': ' . JText::_('COM_VOLUNTEERS_TITLE_TEAMS_EDIT'), 'joomla');
		...
		else
		{
			...
			{
				JToolbarHelper::versions('com_volunteers.team', $this->item->id);
			}
