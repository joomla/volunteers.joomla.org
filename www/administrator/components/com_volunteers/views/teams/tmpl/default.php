...
<form action="<?php echo JRoute::_('index.php?option=com_volunteers&view=teams'); ?>" method="post" name="adminForm" id="adminForm">
							...
							<td class="has-context">
								<div class="pull-left break-word">
									...
									<?php if ($canEdit || $canEditOwn) : ?>
										<a class="hasTooltip" href="<?php echo JRoute::_('index.php?option=com_volunteers&task=team.edit&id=' . $item->id); ?>" title="<?php echo JText::_('JACTION_EDIT'); ?>">
									...
									<div class="small">
										<?php if ($item->parent_id): ?>
											<i><?php echo JText::_('COM_VOLUNTEERS_FIELD_TEAM_PARENT') . ": " . $this->escape($item->parent_title); ?></i>
											<br>
										<?php endif; ?>
