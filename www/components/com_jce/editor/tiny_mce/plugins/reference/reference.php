...
class WFReferencePlugin extends WFEditorPlugin
{
    ...
    public function display()
    {
        ...
        $document->addScript(array('reference'), 'plugins');
        $document->addStyleSheet(array('reference'), 'plugins');

        $document->addScriptDeclaration('ReferenceDialog.settings=' . json_encode($this->getSettings()) . ';');
