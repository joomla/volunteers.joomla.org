		...
		<div class="tab-content">
			...
			<div class="tab-pane" id="reportsTeams">
				<?php if ($this->item->reportsTeams): ?>
					...
					<a href="<?php echo JRoute::_('index.php?option=com_volunteers&view=reports') ?>" class="btn">
						<span class="icon-chevron-right"></span><?php echo JText::_('COM_VOLUNTEERS_READ_MORE_REPORTS'); ?>&nbsp
					</a>
