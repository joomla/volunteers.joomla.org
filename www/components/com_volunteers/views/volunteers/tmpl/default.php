			...
			<div class="filter-bar">
				<div class="btn-group float-end">
					...
					<div class="input-group">
						<input class="form-control" type="text" name="filter_search" id="filter-search" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" class="inputbox" onchange="document.adminForm.submit();" placeholder="<?php echo JText::_('COM_VOLUNTEERS_SEARCH_VOLUNTEER'); ?>"/>
