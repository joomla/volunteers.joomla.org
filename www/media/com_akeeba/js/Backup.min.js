...
akeeba.Loader.add(["akeeba.UserInterfaceCommon","akeeba.System","akeeba.Ajax"],function(){akeeba.System.notification.askPermission();akeeba.System.addEventListener("comAkeebaBackupProfileDropdown","change",akeeba.Backup.flipProfile);akeeba.System.addEventListener("comAkeebaBackupFlipProfile",function(){akeeba.Backup.flipProfile();return!1});akeeba.System.addEventListener("comAkeebaBackupCancelResume",akeeba.Backup.cancelResume);akeeba.System.addEventListener("comAkeebaBackupResumeBackup",akeeba.Backup.resumeBackup);
akeeba.System.getOptions("akeeba.Backup.autostart")?akeeba.Backup.start():(akeeba.System.addEventListener("backup-start","click",akeeba.Backup.start),akeeba.System.addEventListener("backup-default","click",akeeba.Backup.restoreDefaultOptions),setTimeout(akeeba.Backup.restoreCurrentOptions,500))}); //# sourceMappingURL=Backup.min.map
