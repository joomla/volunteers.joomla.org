...
"click",akeeba.Backup.resumeBackup);akeeba.System.getOptions("akeeba.Backup.autostart")?akeeba.Backup.start():(akeeba.System.addEventListener("backup-start","click",akeeba.Backup.start),akeeba.System.addEventListener("backup-default","click",akeeba.Backup.restoreDefaultOptions),setTimeout(akeeba.Backup.restoreCurrentOptions,500))}); //# sourceMappingURL=Backup.min.map
