...
"100%");e.setAttribute("height",400);e.setAttribute("frameborder",0);e.setAttribute("allowtransparency","true");d.appendChild(e);akeeba.Loader.add("akeeba.Modal",function(){akeeba.Configuration.fsBrowser.modalObject=akeeba.Modal.open({inherit:"#"+akeeba.Configuration.fsBrowser.params.dialogId,width:"80%"})})};
...
c.style.display="none"):(d.textContent=akeeba.System.Text._("COM_AKEEBA_CONFIG_DIRECTFTP_TEST_FAIL"),c.textContent=a,b.style.display="none",c.style.display="block");akeeba.Loader.add("akeeba.Modal",function(){akeeba.Modal.open({inherit:"#testFtpDialog",width:"80%"})})},null,!1,15E3)};
