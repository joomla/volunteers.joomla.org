...
akeeba.Wizard.minExecApply=function(a){akeeba.Backup.resetTimeoutBar();akeeba.Backup.startTimeoutBar(25E3,100);document.getElementById("backup-substep").textContent=akeeba.System.Text._("COM_AKEEBA_CONFWIZ_UI_SAVEMINEXEC");akeeba.System.doAjax({act:"applyminexec",minexec:a},function(a){document.getElementById("step-minexec").className="akeeba-label--green";akeeba.Wizard.directories()},function(){document.getElementById("backup-progress-pane").style.display="none";document.getElementById("error-panel").style.display=
...
akeeba.System.Text._("COM_AKEEBA_CONFWIZ_UI_PARTSIZE").replace("%s",b.toFixed(3));document.getElementById("step-splitsize").className="akeeba-label--teal";akeeba.System.doAjax({act:"partsize",blocks:a},function(a){a?(document.getElementById("step-splitsize").className="akeeba-label--green",akeeba.Wizard.done()):akeeba.Wizard.partSize()},function(a){akeeba.Wizard.partSize()},!1,6E4)}};
akeeba.Wizard.done=function(){document.getElementById("backup-progress-pane").style.display="none";document.getElementById("backup-complete").style.display="block"};akeeba.System.documentReady(function(){akeeba.Wizard.boot()}); //# sourceMappingURL=ConfigurationWizard.min.map
