...
*/
if("undefined"==typeof akeeba)var akeeba={};"undefined"==typeof akeeba.ControlPanel&&(akeeba.ControlPanel={needsDownloadID:!0,outputDirUnderSiteRoot:!1,hasSecurityFiles:!1});akeeba.ControlPanel.showChangelog=function(){akeeba.Loader.add("akeeba.Modal",function(){akeeba.Modal.open({inherit:"#akeeba-changelog",width:"80%"})})};
...
akeeba.Loader.add(["akeeba.System","akeeba.Ajax"],function(){akeeba.System.params.errorCallback=function(c){};akeeba.System.addEventListener("comAkeebaControlPanelProfileSwitch","change",function(){document.forms.switchActiveProfileForm.submit()});akeeba.System.addEventListener(document.getElementById("btnchangelog"),"click",akeeba.ControlPanel.showChangelog);akeeba.System.notification.askPermission();akeeba.ControlPanel.checkOutputFolderSecurity();var a=document.getElementById("notfixedperms");null!==
a&&a.parentElement.removeChild(a)}); //# sourceMappingURL=ControlPanel.min.map
