...
break;case "trigger":h="akion-flash",b="COM_AKEEBA_DBFILTER_TABLE_TRIGGER"}m=document.createElement("span");f=document.createElement("span");g=document.createElement("span");e=document.createElement("span");m.className="table-name";m.textContent=d;f.className="table-rowcount";dbef.rows&&(f.textContent=dbef.rows,f.setAttribute("title",akeeba.System.Text._("COM_AKEEBA_DBFILTER_TABLE_META_ROWCOUNT")),f.setAttribute("data-akeeba-tooltip-position","left"));g.className="table-icon-container table-icon-noclick table-icon-small";
g.setAttribute("title",akeeba.System.Text._(b));g.setAttribute("data-akeeba-tooltip-position","bottom");b=document.createElement("span");b.className=h;g.appendChild(b);e.className="table-icon-container table-icon-noclick table-icon-small";h=document.createElement("span");h.className="akion-android-more-vertical";h.style.color="#cccccc";e.appendChild(h);k.appendChild(e);k.appendChild(g);k.appendChild(m);k.appendChild(f);c.appendChild(k)}};
akeeba.Dbfilters.loadTab=function(a){a={action:JSON.stringify({verb:"tab",root:a})};akeeba.System.doAjax(a,function(c){akeeba.Dbfilters.renderTab(c)},null,!1,15E3)};
