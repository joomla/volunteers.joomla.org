...
*/
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.arrayIteratorImpl=function(a){var b=0;return function(){return b<a.length?{done:!1,value:a[b++]}:{done:!0}}};$jscomp.arrayIterator=function(a){return{next:$jscomp.arrayIteratorImpl(a)}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;$jscomp.ISOLATE_POLYFILLS=!1;$jscomp.FORCE_POLYFILL_PROMISE=!1;
...
$jscomp.polyfill("Symbol",function(a){if(a)return a;var b=function(e,g){this.$jscomp$symbol$id_=e;$jscomp.defineProperty(this,"description",{configurable:!0,writable:!0,value:g})};b.prototype.toString=function(){return this.$jscomp$symbol$id_};var d=0,f=function(e){if(this instanceof f)throw new TypeError("Symbol is not a constructor");return new b("jscomp_symbol_"+(e||"")+"_"+d++,e)};return f},"es6","es3");$jscomp.initSymbolIterator=function(){};
...
"es3");$jscomp.initSymbolAsyncIterator=function(){};$jscomp.iteratorPrototype=function(a){a={next:a};a[Symbol.iterator]=function(){return this};return a};$jscomp.iteratorFromArray=function(a,b){a instanceof String&&(a+="");var d=0,f=!1,e={next:function(){if(!f&&d<a.length){var g=d++;return{value:b(g,a[g]),done:!1}}f=!0;return{done:!0,value:void 0}}};e[Symbol.iterator]=function(){return e};return e};
$jscomp.polyfill("Array.prototype.keys",function(a){return a?a:function(){return $jscomp.iteratorFromArray(this,function(b){return b})}},"es6","es3");if("undefined"==typeof akeeba)var akeeba={};"undefined"==typeof akeeba.Fsfilters&&(akeeba.Fsfilters={currentRoot:null});akeeba.Fsfilters.activeRootChanged=function(){var a=document.getElementById("active_root"),b={};b.root=a.options[a.selectedIndex].value;b.crumbs=[];b.node="";akeeba.Fsfilters.load(b)};
akeeba.Fsfilters.activeTabRootChanged=function(){var a=document.getElementById("active_root");akeeba.Fsfilters.loadTab(a.options[a.selectedIndex].value)};akeeba.Fsfilters.load=function(a){a.verb="list";a=JSON.stringify(a);var b={};b.action=a;akeeba.System.doAjax(b,function(d){akeeba.Fsfilters.render(d)},null,!1,15E3)};
...
break;case "skipfiles_all":k="akion-document",c.insertAdjacentHTML("beforeend",'<span class="ak-toggle-button akion-document"></span>')}akeeba.System.addEventListener(c,"click",function(m,l){return function(){if(-1!=m.className.indexOf("akeeba-btn--orange")){akeeba.System.removeClass(m,"akeeba-btn--orange");akeeba.System.addClass(m,"akeeba-btn--grey");var n=!1}else akeeba.System.removeClass(m,"akeeba-btn--grey"),akeeba.System.addClass(m,"akeeba-btn--orange"),n=!0;for(var p=1;p<b.children.length;p++){var q=
b.children[p].querySelector("span."+l),r=-1!=q.parentNode.className.indexOf("akeeba-btn--orange");!n&&!r||n&&r||akeeba.System.triggerEvent(q,"click")}}}(c,k));f.appendChild(c)}c=document.createElement("span");c.className="folder-name";c.innerHTML='<span class="pull-left akion-arrow-down-a"></span>'+akeeba.System.Text._("COM_AKEEBA_FILEFILTERS_TYPE_APPLYTOALLDIRS");f.appendChild(c);b.appendChild(f)}for(var h in a.folders){if(!a.folders.hasOwnProperty(h))return;f=a.folders[h];uielement=document.createElement("div");
uielement.className="folder-container";d=["directories","skipdirs","skipfiles"];for(e=0;e<d.length;e++){g=d[e];c=document.createElement("span");c.className="akeeba-btn--mini akeeba-btn--grey folder-icon-container";c.setAttribute("title",'<div class="tooltip-arrow-up-leftaligned"></div><div>'+akeeba.System.Text._("COM_AKEEBA_FILEFILTERS_TYPE_"+g.toUpperCase())+"</div>");switch(g){case "directories":c.insertAdjacentHTML("beforeend",'<span class="ak-toggle-button akion-close-circled"></span>');break;
case "skipdirs":c.insertAdjacentHTML("beforeend",'<span class="ak-toggle-button akion-folder"></span>');break;case "skipfiles":c.insertAdjacentHTML("beforeend",'<span class="ak-toggle-button akion-document"></span>')}c.setAttribute("data-akeeba-tooltip-position","right");switch(f[g]){case 2:akeeba.System.removeClass(c,"akeeba-btn--grey");akeeba.System.addClass(c,"akeeba-btn--red");break;case 1:akeeba.System.removeClass(c,"akeeba-btn--grey"),akeeba.System.addClass(c,"akeeba-btn--orange");case 0:akeeba.System.addEventListener(c,
"click",function(m,l,n){return function(){akeeba.Fsfilters.toggle({root:a.root,crumbs:crumbs,node:m,filter:l,verb:"toggle"},n)}}(h,g,c))}uielement.appendChild(c)}c=document.createElement("span");c.textContent=h;f.link&&(c.innerHTML='<span class="akion-link" aria-hidden="true"></span> '+c.innerHTML);c.className="folder-name";akeeba.System.addEventListener(c,"click",function(m){return function(){var l=document.createElement("img");l.setAttribute("src",akeeba.System.getOptions("akeeba.Fsfilters.loadingGif",
""));l.setAttribute("width",16);l.setAttribute("height",11);l.setAttribute("border",0);l.setAttribute("alt","Loading...");l.style.marginTop="3px";l.style.marginLeft="5px";this.appendChild(l);akeeba.Fsfilters.load({root:a.root,crumbs:crumbs,node:m})}}(h));uielement.appendChild(c);b.appendChild(uielement)}h=document.getElementById("files");h.innerHTML="";0<Object.keys(a.files).length&&(g=document.createElement("div"),g.className="file-header file-container",c=document.createElement("span"),c.className=
"file-icon-container akeeba-btn--mini akeeba-btn--grey",c.insertAdjacentHTML("beforeend",'<span class="ak-toggle-button akion-close-circled"></span>'),c.setAttribute("title",'<div class="tooltip-arrow-up-leftaligned"></div><div>'+akeeba.System.Text._("COM_AKEEBA_FILEFILTERS_TYPE_FILES_ALL")+"</div>"),c.setAttribute("data-akeeba-tooltip-position","right"),akeeba.System.addEventListener(c,"click",function(m){return function(){if(-1!=this.className.indexOf("akeeba-btn--orange")){akeeba.System.removeClass(this,
"akeeba-btn--orange");akeeba.System.addClass(this,"akeeba-btn--grey");var l=!1}else akeeba.System.removeClass(this,"akeeba-btn--grey"),akeeba.System.addClass(this,"akeeba-btn--orange"),l=!0;for(var n=document.getElementById("files"),p=1;p<n.children.length;p++){var q=n.children[p].querySelector("span.akion-close-circled"),r=-1!=q.parentNode.className.indexOf("akeeba-btn--orange");!l&&!r||l&&r||akeeba.System.triggerEvent(q,"click")}}}(c)),g.appendChild(c),c=document.createElement("span"),c.className=
"file-name",c.innerHTML='<span class="pull-left akion-arrow-down-a"></span>'+akeeba.System.Text._("COM_AKEEBA_FILEFILTERS_TYPE_APPLYTOALLFILES"),g.appendChild(c),h.appendChild(g));for(fileName in a.files)if(a.files.hasOwnProperty(fileName)){f=a.files[fileName];uielement=document.createElement("div");uielement.className="file-container";d=["files"];for(e=0;e<d.length;e++){g=d[e];c=document.createElement("span");c.className="file-icon-container akeeba-btn--mini akeeba-btn--grey";switch(g){case "files":c.insertAdjacentHTML("beforeend",
'<span class="ak-toggle-button akion-close-circled"></span>')}c.setAttribute("title",'<div class="tooltip-arrow-up-leftaligned"></div><div>'+akeeba.System.Text._("COM_AKEEBA_FILEFILTERS_TYPE_"+g.toUpperCase())+"</div>");c.setAttribute("data-akeeba-tooltip-position","right");switch(f[g]){case 2:akeeba.System.removeClass(c,"akeeba-btn--grey");akeeba.System.addClass(c,"akeeba-btn--red");break;case 1:akeeba.System.removeClass(c,"akeeba-btn--grey"),akeeba.System.addClass(c,"akeeba-btn--orange");case 0:akeeba.System.addEventListener(c,
"click",function(m,l,n){return function(){akeeba.Fsfilters.toggle({root:a.root,crumbs:crumbs,node:m,filter:l,verb:"toggle"},n)}}(fileName,g,c))}uielement.appendChild(c)}c=document.createElement("span");c.className="file-name";c.textContent=fileName;f.link&&(c.innerHTML='<span class="akion-link" aria-hidden="true"></span> '+c.innerHTML);uielement.appendChild(c);c=document.createElement("span");c.className="file-size";c.textContent=f.size;uielement.appendChild(c);h.appendChild(uielement)}};
akeeba.Fsfilters.nuke=function(){var a={action:JSON.stringify({root:akeeba.Fsfilters.currentRoot,verb:"reset"})};akeeba.System.doAjax(a,function(b){akeeba.Fsfilters.render(b)},null,!1,15E3)};akeeba.Fsfilters.loadTab=function(a){a={action:JSON.stringify({verb:"tab",root:a})};akeeba.System.doAjax(a,function(b){akeeba.Fsfilters.renderTab(b)},null,!1,15E3)};
