...
$jscomp.iteratorFromArray=function(a,b){$jscomp.initSymbolIterator();a instanceof String&&(a+="");var d=0,f={next:function(){if(d<a.length){var e=d++;return{value:b(e,a[e]),done:!1}}f.next=function(){return{done:!0,value:void 0}};return f.next()}};f[Symbol.iterator]=function(){return f};return f};$jscomp.polyfills={};$jscomp.propertyToPolyfillSymbol={};$jscomp.POLYFILL_PREFIX="$jscp$";$jscomp.IS_SYMBOL_NATIVE="function"===typeof Symbol&&"symbol"===typeof Symbol("x");
var $jscomp$lookupPolyfilledValue=function(a,b){var d=$jscomp.propertyToPolyfillSymbol[b];if(null==d)return a[b];d=a[d];return void 0!==d?d:a[b]};$jscomp.polyfill=function(a,b,d,f){b&&($jscomp.ISOLATE_POLYFILLS?$jscomp.polyfillIsolated(a,b,d,f):$jscomp.polyfillUnisolated(a,b,d,f))};
...
$jscomp.polyfillIsolated=function(a,b,d,f){var e=a.split(".");a=1===e.length;f=e[0];f=!a&&f in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var g=0;g<e.length-1;g++){var c=e[g];c in f||(f[c]={});f=f[c]}e=e[e.length-1];d=$jscomp.IS_SYMBOL_NATIVE&&"es6"===d?f[e]:null;b=b(d);null!=b&&(a?$jscomp.defineProperty($jscomp.polyfills,e,{configurable:!0,writable:!0,value:b}):b!==d&&($jscomp.propertyToPolyfillSymbol[e]=$jscomp.IS_SYMBOL_NATIVE?$jscomp.global.Symbol(e):$jscomp.POLYFILL_PREFIX+e,e=$jscomp.propertyToPolyfillSymbol[e],
$jscomp.defineProperty(f,e,{configurable:!0,writable:!0,value:b})))};$jscomp.polyfill("Array.prototype.keys",function(a){return a?a:function(){return $jscomp.iteratorFromArray(this,function(a){return a})}},"es6","es3");if("undefined"==typeof akeeba)var akeeba={};"undefined"==typeof akeeba.Fsfilters&&(akeeba.Fsfilters={currentRoot:null});akeeba.Fsfilters.activeRootChanged=function(){var a=document.getElementById("active_root"),b={};b.root=a.options[a.selectedIndex].value;b.crumbs=[];b.node="";akeeba.Fsfilters.load(b)};
akeeba.Fsfilters.activeTabRootChanged=function(){var a=document.getElementById("active_root");akeeba.Fsfilters.loadTab(a.options[a.selectedIndex].value)};akeeba.Fsfilters.load=function(a){a.verb="list";a=JSON.stringify(a);var b={};b.action=a;akeeba.System.doAjax(b,function(a){akeeba.Fsfilters.render(a)},null,!1,15E3)};
...
break;case "skipfiles_all":k="akion-document",c.insertAdjacentHTML("beforeend",'<span class="ak-toggle-button akion-document"></span>')}akeeba.System.addEventListener(c,"click",function(a,c){return function(){if(-1!=a.className.indexOf("akeeba-btn--orange")){akeeba.System.removeClass(a,"akeeba-btn--orange");akeeba.System.addClass(a,"akeeba-btn--grey");var d=!1}else akeeba.System.removeClass(a,"akeeba-btn--grey"),akeeba.System.addClass(a,"akeeba-btn--orange"),d=!0;for(var e=1;e<b.children.length;e++){var f=
b.children[e].querySelector("span."+c),g=-1!=f.parentNode.className.indexOf("akeeba-btn--orange");!d&&!g||d&&g||akeeba.System.triggerEvent(f,"click")}}}(c,k));f.appendChild(c);akeeba.Tooltip.simpleTooltip(c)}c=document.createElement("span");c.className="folder-name";c.innerHTML='<span class="pull-left akion-arrow-down-a"></span>'+akeeba.System.Text._("COM_AKEEBA_FILEFILTERS_TYPE_APPLYTOALLDIRS");f.appendChild(c);b.appendChild(f)}for(var h in a.folders){if(!a.folders.hasOwnProperty(h))return;f=a.folders[h];
...
akeeba.System.addClass(this,"akeeba-btn--grey");var a=!1}else akeeba.System.removeClass(this,"akeeba-btn--grey"),akeeba.System.addClass(this,"akeeba-btn--orange"),a=!0;for(var b=document.getElementById("files"),c=1;c<b.children.length;c++){var d=b.children[c].querySelector("span.akion-close-circled"),e=-1!=d.parentNode.className.indexOf("akeeba-btn--orange");!a&&!e||a&&e||akeeba.System.triggerEvent(d,"click")}}}(c)),g.appendChild(c),c=document.createElement("span"),c.className="file-name",c.innerHTML=
...
"akeeba-btn--orange");case 0:akeeba.System.addEventListener(c,"click",function(b,c,d){return function(){akeeba.Fsfilters.toggle({root:a.root,crumbs:crumbs,node:b,filter:c,verb:"toggle"},d)}}(fileName,g,c))}uielement.appendChild(c)}c=document.createElement("span");c.className="file-name";c.textContent=fileName;uielement.appendChild(c);c=document.createElement("span");c.className="file-size";c.textContent=f.size;uielement.appendChild(c);h.appendChild(uielement)}};
