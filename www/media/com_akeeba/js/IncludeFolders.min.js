...
akeeba.Loader.add(["akeeba.UserInterfaceCommon","akeeba.System","akeeba.Configuration"],function(){var a=akeeba.System.getOptions("akeeba.IncludeFolders.guiData",null);null!==a&&(akeeba.Configuration.enablePopoverFor(document.querySelectorAll('[rel="popover"]')),akeeba.Extradirs.render(a))}); //# sourceMappingURL=IncludeFolders.min.map
