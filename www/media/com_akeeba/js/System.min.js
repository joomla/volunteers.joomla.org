...
akeeba.System.array_diff=function(a){var b={},c=arguments.length,d="",e,f="";a:for(d in a)for(e=1;e<c;e++){var l=arguments[e];for(f in l)if(l[f]===a[d])continue a;b[d]=a[d]}return b};
...
akeeba.System.doAjax=function(a,b,c,d,e){null==d&&(d=!0);var f=(new Date).getTime()/1E3,l=parseInt(String(f),10);a._cacheBustingJunk=Math.round(1E3*(f-l))/1E3;null==e&&(e=6E5);f=akeeba.System.getOptions("akeeba.System.params.AjaxURL",akeeba.System.params.AjaxURL);a.hasOwnProperty("ajaxURL")&&(f=a.ajaxURL,delete a.url);null==c&&(c=akeeba.System.getOptions("akeeba.System.params.errorCallback",akeeba.System.params.errorCallback));null==c&&(c=akeeba.System.defaultErrorHandler);var h={type:"POST",url:f,
cache:!1,data:a,timeout:e,success:function(g){var m=g.indexOf("###");if(-1===m)g=akeeba.System.sanitizeErrorMessage(g),c("Invalid AJAX data: "+g);else{var k=g;0!==m&&(k=g.substr(m));k=k.substr(3);m=k.lastIndexOf("###");k=k.substr(0,m);try{var n=JSON.parse(k)}catch(p){k=akeeba.System.sanitizeErrorMessage(k);g=p.message+"\n<br/>\n<pre>\n"+k+"\n</pre>";c(g);return}b(n)}},error:function(g,m,k){k=g.responseText?g.responseText:"";var n="<strong>AJAX Loading Error</strong><br/>HTTP Status: "+g.status+" ("+
g.statusText+")<br/>";n=n+"Internal status: "+m+"<br/>XHR ReadyState: "+g.readyState+"<br/>";n=n+"Raw server response:<br/>"+akeeba.System.sanitizeErrorMessage(k);c(n)}};d?akeeba.Loader.add("akeeba.Ajax",function(){akeeba.Ajax.enqueue(h)}):akeeba.Loader.add("akeeba.Ajax",function(){akeeba.Ajax.ajax(h)})};akeeba.System.sanitizeErrorMessage=function(a){-1<a.indexOf("<script")&&(a="(HTML containing script tags)");return a};
...
akeeba.System.addEventListener=function(a,b,c){function d(e){var f=c.apply(this,arguments);!1===f&&(e.stopPropagation()&&e.stopPropagation(),e.preventDefault?e.preventDefault():e.returnValue=!1);return f}"string"===typeof a&&(a=document.getElementById(a));null!=a&&"object"==typeof a&&a instanceof Element&&(a.addEventListener?a.addEventListener(b,d,!1):a.attachEvent("on"+b,function(){var e=c.call(a,window.event);!1===e&&(window.event.returnValue=!1,window.event.cancelBubble=!0);return e}))};
...
akeeba.System.triggerEvent=function(a,b){if("undefined"!=typeof a&&null!==a&&("string"===typeof a&&(a=document.getElementById(a)),"object"==typeof a&&a instanceof Element))if("click"===b&&a.click(),"function"===typeof window.jQuery)window.jQuery(a).trigger(b);else if(document.fireEvent&&"undefined"==typeof window.Event)a.fireEvent("on"+b);else{var c=document.createEvent("Event");c.initEvent(b,!0,!0);a.dispatchEvent(c)}};
(function(a,b){function c(){if(!f){f=!0;for(var h=0;h<e.length;h++)e[h].fn.call(window,e[h].ctx);e=[]}}function d(){"complete"===document.readyState&&c()}b=b||akeeba.System;var e=[],f=!1,l=!1;b[a||"documentReady"]=function(h,g){f?setTimeout(function(){h(g)},1):(e.push({fn:h,ctx:g}),"complete"===document.readyState||!document.attachEvent&&"interactive"===document.readyState?setTimeout(c,1):l||(l=!0,document.addEventListener?(document.addEventListener("DOMContentLoaded",c,!1),window.addEventListener("load",
