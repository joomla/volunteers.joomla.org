...
cache:!1,data:a,timeout:e,success:function(a){var d=a.indexOf("###");if(-1===d)a=akeeba.System.sanitizeErrorMessage(a),c("Invalid AJAX data: "+a);else{var e=a;0!==d&&(e=a.substr(d));e=e.substr(3);d=e.lastIndexOf("###");e=e.substr(0,d);try{var f=JSON.parse(e)}catch(k){e=akeeba.System.sanitizeErrorMessage(e);a=k.message+"\n<br/>\n<pre>\n"+e+"\n</pre>";c(a);return}b(f)}},error:function(a,b,d){d=a.responseText?a.responseText:"";var e="<strong>AJAX Loading Error</strong><br/>HTTP Status: "+a.status+" ("+
a.statusText+")<br/>";e=e+"Internal status: "+b+"<br/>XHR ReadyState: "+a.readyState+"<br/>";e=e+"Raw server response:<br/>"+akeeba.System.sanitizeErrorMessage(d);c(e)}};d?akeeba.Loader.add("akeeba.Ajax",function(){akeeba.Ajax.enqueue(h)}):akeeba.Loader.add("akeeba.Ajax",function(){akeeba.Ajax.ajax(h)})};akeeba.System.sanitizeErrorMessage=function(a){-1<a.indexOf("<script")&&(a="(HTML containing script tags)");return a};
