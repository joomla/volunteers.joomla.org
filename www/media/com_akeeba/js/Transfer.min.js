...
akeeba.Transfer.onUrlChange=function(a){void 0===a&&(a=!1);var b=document.getElementById("akeeba-transfer-url"),c=b.value;""==c&&(document.getElementById("akeeba-transfer-lbl-url").style.display="block");"http://"!=c.substring(0,7)&&"https://"!=c.substring(0,8)&&(c="http://"+c);var e=akeeba.Transfer.lastUrl?akeeba.Transfer.lastUrl:akeeba.System.getOptions("akeeba.Transfer.lastUrl",""),d=akeeba.Transfer.lastResult?akeeba.Transfer.lastResult:akeeba.System.getOptions("akeeba.Transfer.lastResult","");
if(a||c!==e){a=document.querySelectorAll("#akeeba-transfer-row-url > div");for(i=0;i<a.length;i++)a[i].style.display="none";b.setAttribute("disabled","disabled");document.getElementById("akeeba-transfer-btn-url").setAttribute("disabled","disabled");document.getElementById("akeeba-transfer-loading").style.display="inline-block";akeeba.System.doAjax({task:"checkUrl",url:c},akeeba.Transfer.applyUrlCheck,function(a){b.removeAttribute("disabled");document.getElementById("akeeba-transfer-btn-url").removeAttribute("disabled");
document.getElementById("akeeba-transfer-loading").style.display="none"},!1,1E4);return!1}akeeba.Transfer.applyUrlCheck({status:d,url:e})};
...
"none";document.getElementById("akeeba-transfer-btn-apply").removeAttribute("disabled");document.getElementById("akeeba-transfer-ftp-method").removeAttribute("disabled");a=document.getElementById("akeeba-transfer-ftp-error");document.getElementById("akeeba-transfer-ftp-error-body").textContent=akeeba.System.Text._("COM_AKEEBA_CONFIG_DIRECTFTP_TEST_FAIL");a.style.display="block";akeeba.System.triggerEvent(a,"focus");akeeba.Transfer.onTransferMethodChange()},!1,15E3))};
akeeba.Transfer.uploadKickstart=function(){var a=document.getElementById("akeeba-transfer-upload-lbl-kickstart"),b=document.getElementById("akeeba-transfer-upload-lbl-archive"),c=document.getElementById("akeeba-transfer-upload-error"),e=document.getElementById("akeeba-transfer-upload-error-body"),d=document.getElementById("akeeba-transfer-upload-error-force");c.style.display="none";d.style.display="none";e.innerHTML="";a.className="akeeba-label--orange";b.className="akeeba-label--grey";document.getElementById("akeeba-transfer-upload-area-kickstart").style.display=
"none";document.getElementById("akeeba-transfer-upload-area-upload").style.display="block";document.getElementById("akeeba-transfer-upload").style.display="block";akeeba.System.doAjax({task:"initialiseUpload"},function(f){f.status?akeeba.Transfer.uploadArchive(1):(d&&(d.style.display="none",f.ignorable&&(d.style.display="inline-block")),a.className="akeeba-label--red",e.innerHTML=f.message,c.style.display="block")},null,!1,15E4)};
akeeba.Transfer.uploadArchive=function(a){void 0===a&&(a=0);var b=document.getElementById("akeeba-transfer-upload-lbl-kickstart"),c=document.getElementById("akeeba-transfer-upload-lbl-archive"),e=document.getElementById("akeeba-transfer-upload-error"),d=document.getElementById("akeeba-transfer-upload-error-body");d.innerHTML="";e.style.display="none";b.className="akeeba-label--green";c.className="akeeba-label--orange";akeeba.System.doAjax({task:"upload",start:a},function(a){if(a.result)if(a.done){document.getElementById("akeeba-transfer-upload-percent").textContent=
"100 %";document.getElementById("akeeba-transfer-upload-size").innerHTML="";document.getElementById("akeeba-transfer-upload-area-kickstart").style.display="block";document.getElementById("akeeba-transfer-upload-area-upload").style.display="none";var b=document.getElementById("akeeba-transfer-url").value.replace(/\/$/,"")+"/kickstart.php";document.getElementById("akeeba-transfer-upload-btn-kickstart").setAttribute("href",b)}else{b=0;var f=1*a.totalSize;a=1*a.doneSize;0<f&&0<a&&(b=a/f*100);document.getElementById("akeeba-transfer-upload-percent").textContent=
b.toFixed(2)+"%";document.getElementById("akeeba-transfer-upload-size").textContent=a.toFixed(0)+" / "+f.toFixed(0)+" bytes";window.setTimeout(function(){akeeba.Transfer.uploadArchive(0)},50)}else c.className="akeeba-label--red",d.innerHTML=a.message,e.style.display="block"},null,!1,15E4)};
