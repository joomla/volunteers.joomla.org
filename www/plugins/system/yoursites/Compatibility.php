...
/**
 * Compatibility class. It is used to check for versions of extensions compatible with specified Joomla Version
 *
 * @since  3.10.0
 */
class Compatibility extends \JObject
{
	...
	/**
	 * Collection of extension update array
	 *
	 * @var    array
	 * @since  3.10.0
	 */
	...
	public function _startElement($parser, $name, $attrs = array())
	{
		...
		switch ($name)
		{
			// This is a collection so we must search for matching extensions
			case 'EXTENSIONSET':
				break;
